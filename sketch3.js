...
function preload() {
  source = loadImage('img/c71ba316-54a9-4b6f-a3e1-779288a3b6a6.jpg');
}

function setup() {
  // Resize the image to fit within the canvas
  source.resize(400, 0); // Resize width to 400px, maintain aspect ratio for height
  ...
  console.log('Setup complete. Tiles:', tiles);
}
